    ...
    <main className="relative min-h-screen bg-white text-black overflow-hidden">
      ...
      <section className="relative flex flex-col justify-center items-center min-h-[85vh] px-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl text-center">
          ...
          <p className="text-2xl mb-10 font-medium text-gray-800">
            AI-Assisted Smart City Governance Platform
          </p>

          {/* Paragraph (FULLY UPPERCASE) */}
          <p className="text-lg mb-10 leading-relaxed max-w-2xl mx-auto text-gray-700 uppercase tracking-wide">
