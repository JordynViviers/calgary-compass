        ...
        <section id="upcoming-events" className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">Calgary Central Library</p>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-2">July 2, 2026</p>
              <p className="text-gray-600 mb-4">University of Calgary</p>

              <p className="text-gray-700 mb-6">
                Explore emerging transportation technologies and citizen needs.
              </p>
        ...
        <section className="mb-16">
          <div className="bg-white border border-gray-200 rounded-2xl p-10 text-center shadow-sm">
            ...
            <p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
              A community discussion exploring emerging technologies, public
              values, and the future of city services.
            </p>
